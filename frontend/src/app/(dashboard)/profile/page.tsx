...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-6 pb-12 bg-[#EDEAFD] min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="rounded-3xl bg-white p-5 border border-[#E5E4E8] shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm font-bold text-[#3C315B]">{user?.role || 'STUDENT'}</p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-5 border border-[#E5E4E8] shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            <span className="text-[10px] text-[#3C315B]/60 font-bold tracking-wider uppercase block">MFA STATUS</span>
            <p className="text-sm font-bold text-[#3C315B]">TOTP</p>
            <p className="text-[11px] text-[#3C315B]/60 font-normal">Speakeasy authenticator</p>
          </div>
          <div className="w-10 h-10 rounded-full bg-[#ECE8FE] text-[#6A4FE0] flex items-center justify-center">
        ...
        <div className="rounded-3xl bg-white p-5 border border-[#E5E4E8] shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            <span className="text-[10px] text-[#3C315B]/60 font-bold tracking-wider uppercase block">PREFERENCES</span>
            <p className="text-sm font-bold text-emerald-600">3</p>
            <p className="text-[11px] text-[#3C315B]/60 font-normal">Lifestyle categories set</p>
          </div>
      ...
      {/* Roommate Behavioral Profile Card */}
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#3C315B]">Current Password</label>
              <input
                type="password"
                placeholder="••••••••••••"
                value={passwordForm.currentPassword}
                onChange={(e) => setPasswordForm((prev) => ({ ...prev, currentPassword: e.target.value }))}
                className="w-full h-11 px-4 rounded-2xl border border-[#E5E4E8] bg-[#FAFAFA] text-xs font-semibold text-[#3C315B] focus:bg-white"
              />
            </div>
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#3C315B]">New Password (Min 12 Chars)</label>
              <input
                type="password"
                placeholder="••••••••••••"
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#3C315B]">Confirm New Password</label>
              <input
                type="password"
                placeholder="••••••••••••"
          ...
          <button
            ...
            className="w-full sm:w-auto h-11 px-6 rounded-xl bg-[#6A4FE0] hover:bg-[#5B3FD1] text-white font-bold text-xs transition-all shadow-md disabled:opacity-50"
          >
      ...
      <div className="rounded-3xl bg-white p-6 border border-[#E5E4E8] shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          type="button"
          onClick={() => router.push(isStudent ? '/student/mfa-setup' : '/warden/mfa-setup')}
